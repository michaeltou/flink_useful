...
public class HotItemsFromProjectFile {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // UserBehavior.csv 的本地文件路径
         URL fileUrl = HotItemsFromDiskFile.class.getClassLoader().getResource("UserBehavior.csv");
       ...
       /* DataStream<UserBehavior> timedData2 = dataSource
